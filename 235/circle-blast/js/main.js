...
function gameLoop(){
    ...
    for (let b of bullets)
    {
        ...
        // Moved this here for optimization purposes. No need to check this per circle per bullet when it could just be checked per bullet
        if (b.y < -10)
        {
    ...
    for (let c of circles)
    {
        ...
        for (let b of bullets)
        {
            if (c.isAlive && b.isAlive && rectsIntersect(c, b))
            {
                fireballSound.play();
